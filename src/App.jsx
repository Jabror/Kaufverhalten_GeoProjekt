...
const QUESTIONS = [
  ...
  { id: 9,  text: "Glaubst du, dass Influencer ehrlich über Produkte sprechen?", multi: false, options: ["Ja, meistens","Manchmal(Jedes viertemal sind sie nicht erhlich)","Selten(Jedes viertemal sind sie erhlich)","Nie"] },
  ...
  { id: 11, text: "Wie stark beeinflussen Influencer deine Kaufentscheidungen?", multi: false, options: ["Sehr stark(Ich kaufe nur das was ein Influencer mir empfiehlt)","Stark","Mittel(Ich nehme Ratschläge vom Influencer an, jedoch mache ich immer noch meine eigene Kaufentscheidung)","Wenig","Gar nicht"] },
  { id: 12, text: "Hast du schon einmal etwas gekauft und es später bereut, weil ein Influencer es empfohlen hat?", multi: false, options: ["Ja, über fünf Mal","Ja, ein - fünf Mal","Nein", "Nein, ich habe noch nie wegen eines Influencers etwas gekauft"] },
...
// ── WICHTIG: "to" muss EXAKT mit dem Text in "options" oben übereinstimmen ──
const ANSWER_MAPPINGS = [
  ...
  { qid: 9,  from: "Selten",             to: "Selten(Jedes viertemal sind sie erhlich)" },
