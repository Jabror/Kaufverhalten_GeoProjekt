...
const QUESTIONS = [
  ...
  { id: 7,  text: "Warum vertraust du der Empfehlung eines Influencers? (Mehrfachauswahl möglich)", multi: true, options: ["Ich finde die Person sympathisch/authentisch","Ich sehe das Produkt im täglichen Einsatz (Storys/Vlogs)","Die Ergebnisse/Vorher-Nachher-Effekte überzeugen mich","Weil viele andere aus meiner Peergroup es auch kaufen","Ich vertraue Influencer-Empfehlungen generell nicht"] },
  ...
  { id: 17, text: "Findest du es nervig, wenn influencer für Produkte Werbung machen?", multi: false, options: ["Nervig","Eher nervig","Neutral","Nicht nervig"] },
