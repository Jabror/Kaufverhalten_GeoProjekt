...
const QUESTIONS = [
  ...
  { id: 12, text: "Hast du schon einmal etwas gekauft und es später bereut, weil ein Influencer es empfohlen hat?", multi: false, options: ["Ja, oft","Ja, einmal oder ein paar Mal","Ich habe etwas gekauft, aber nicht bereut", "Nein, ich habe noch nie etwas von einem influencer gekauft"] },
